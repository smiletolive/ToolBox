package com.lib.commui.nova.widget.guide.model;

import android.view.View;

import com.lib.commui.nova.widget.guide.listener.OnHighlightDrewListener;
...
public class HighlightOptions {
    ...
    /**
     * 点击后是否 关闭 或者 显示下一个引导页（默认关闭）
     */
    public boolean isClickedDismiss = true;
    ...
    public static class Builder {
         ...
         * 点击后是否关闭 或者 显示下一个引导页
         */
        public Builder setClickedDismiss(boolean isDismiss) {
            options.isClickedDismiss = isDismiss;
            return this;
        }
